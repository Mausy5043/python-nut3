...
from nut3 import PyNUT3Client, PyNUT3Error


class TestClient(unittest.TestCase):

    def setUp(self):
        self.client = PyNUT3Client(connect=False, debug=True)
        self.client._srv_handler = MockServer(broken=False)
        self.broken_client = PyNUT3Client(connect=False, debug=True)
        self.broken_client._srv_handler = MockServer(broken=True)
        self.not_ok_client = PyNUT3Client(connect=False, debug=True)
    ...
    def test_init_with_args(self):
        PyNUT3Client(connect=False, login='test', password='test',
                     host='test', port=1)

    def test_supports_context_manager(self):
        try:
            with PyNUT3Client(connect=False) as client:
                pass
    ...
    def test_connect_debug(self):
        try:
            PyNUT3Client(debug=True)
        except Exception:
            assert (False)

    def test_connect_broken(self):
        telnetlib.Telnet = MockServer
        client = PyNUT3Client(login=self.valid, password=self.valid,
                              connect=False)
        self.assertRaises(PyNUT3Error, client._connect)

    def test_connect_credentials(self):
        try:
            PyNUT3Client(login=self.valid, password=self.valid,
                         debug=True)
        except TypeError:
            pass
        except PyNUT3Error:
    ...
    def test_get_ups_list_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.list_ups)
    ...
    def test_get_ups_vars_invalid_ups(self):
        self.assertRaises(PyNUT3Error, self.client.list_vars, self.invalid)

    def test_get_ups_vars_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.list_vars, self.valid)
    ...
    def test_get_ups_commands_invalid_ups(self):
        self.assertRaises(PyNUT3Error, self.client.list_commands, self.invalid)

    def test_get_ups_commands_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.list_commands,
                          self.valid)
    ...
    def test_get_rw_vars_invalid_ups(self):
        self.assertRaises(PyNUT3Error, self.client.list_rw_vars, self.invalid)
    ...
    def test_set_rw_var_invalid(self):
        self.assertRaises(PyNUT3Error, self.client.set_var, self.invalid,
                          self.invalid, self.invalid)

    def test_set_rw_var_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.set_var, self.valid,
    ...
    def test_run_ups_command_invalid(self):
        self.assertRaises(PyNUT3Error, self.client.run_command, self.invalid,
                          self.invalid)

    def test_run_ups_command_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.run_command, self.valid,
                          self.valid)
    ...
    def test_fsd_invalid_ups(self):
        self.assertRaises(PyNUT3Error, self.client.fsd, self.invalid)

    def test_fsd_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.fsd, self.valid)

    def test_fsd_not_ok(self):
        self.assertRaises(PyNUT3Error, self.not_ok_client.fsd, self.valid)

    def test_help(self):
        self.assertEquals(self.client.help(),
    ...
    def test_list_clients_invalid(self):
        self.assertRaises(PyNUT3Error, self.client.list_clients,
                          self.invalid)
    ...
    def test_list_clients_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.list_clients,
                          self.valid)
    ...
    def test_num_logins_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.num_logins,
                          self.valid)
    ...
    def test_description_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.description,
                          self.valid)
    ...
    def test_get_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.get,
                          self.valid, self.valid)
    ...
    def test_var_description_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.var_description,
                          self.valid, self.valid)
    ...
    def test_command_description_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.command_description,
                          self.valid, self.valid)
    ...
    def test_list_enum_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.list_enum,
                          self.valid, self.valid)
    ...
    def test_list_range_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.list_range,
                          self.valid, self.valid)
    ...
    def test_var_type_broken(self):
        self.assertRaises(PyNUT3Error, self.broken_client.var_type,
                          self.valid, self.valid)
